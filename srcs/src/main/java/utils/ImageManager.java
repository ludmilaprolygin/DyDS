...
public class ImageManager
{
    ...
    public static ImageIcon getRatedImage() { return new ImageIcon(getRatedImageURL()); }
    protected static String getRatedImageURL() { return "srcs/src/main/resources/star.png"; }
}