...
import Presenter.Interfaces.SearchPresenter;
...
public class SearchPresenterImpl implements SearchPresenter
{
    ...
    public SearchPresenterImpl(SearchView searchView, SearchModel searchModel)
    {
    ...
    {
        ArrayList<SearchResult> allSearchResults = getAllSearchResults(jsonResults);
    ...
    protected ArrayList<SearchResult> getAllSearchResults(JsonArray jsonResults)
    {
